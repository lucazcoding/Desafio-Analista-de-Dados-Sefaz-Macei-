...
# Importando as funções dos módulos irmãos do pacote pipeline
from src.pipeline.descobrir_ano import descobrir_ano_pelo_caminho
from src.pipeline.carregar_csv import carregar_csv_finbra
from src.pipeline.enriquecer_dataframe import enriquecer_dados_finbra
